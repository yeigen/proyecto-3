...
log = get_logger('exportar_s5p_no2')
FUENTE = 'COPERNICUS/S5P/OFFL/L3_NO2'
...
def main():
    ...
    log.info(f'S5P NO2 | {len(ids)} imagenes | bandas: {bandas} | escala: {ESCALA}m')
    ...
    with ThreadPoolExecutor(max_workers=MAX_WORKERS) as ex:
        ...
        with tqdm(total=len(ids), desc='S5P NO2', unit='img') as bar:
