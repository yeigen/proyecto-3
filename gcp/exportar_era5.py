...
log = get_logger('exportar_era5')
FUENTE = 'ECMWF/ERA5/HOURLY'
...
def main():
    ...
    log.info(f'ERA5 | {len(ids)} imagenes | bandas: {bandas} | escala: {ESCALA}m')
    ...
    with ThreadPoolExecutor(max_workers=MAX_WORKERS) as ex:
        ...
        with tqdm(total=len(ids), desc='ERA5', unit='img') as bar:
