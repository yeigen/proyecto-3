...
log = get_logger('exportar_s5p_o3')
FUENTE = 'COPERNICUS/S5P/OFFL/L3_O3'
...
def main():
    ...
    log.info(f'S5P O3 | {len(ids)} imagenes | bandas: {bandas} | escala: {ESCALA}m')
    ...
    with ThreadPoolExecutor(max_workers=MAX_WORKERS) as ex:
        ...
        with tqdm(total=len(ids), desc='S5P O3', unit='img') as bar:
