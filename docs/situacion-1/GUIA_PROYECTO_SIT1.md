...
- SCL, que clasifica píxeles como vegetación, suelo, nubes, sombras, agua, entre otros.
...
## 7. Sentinel-5P: contaminantes satelitales
...
- Viento u/v a 10 m.
- Altura de capa límite atmosférica.
- Humedad relativa a 850 hPa.
- Presión superficial.
- Precipitación total.
...
## 9. MODIS MAIAC: aerosoles y vapor de agua
...
## 12. Qué queda claro al cerrar Situación 1
