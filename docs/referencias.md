...
Referencias externas e internas compartidas por la documentación reorganizada.

## Plataformas del proyecto

- [Kaggle Notebook del proyecto](https://www.kaggle.com/code/edwardsx/geovision-proyecto-3)
...
## Fuentes satelitales y meteorológicas
...
- [CVC](https://www.cvc.gov.co/)
- [Resolución 2254 de 2017 — MinAmbiente](https://www.minambiente.gov.co/documento-entidad/resolucion-2254-de-2017/)

## Modelado y métodos

- [CLIP paper](https://arxiv.org/abs/2103.00020)
- [RemoteCLIP paper](https://ieeexplore.ieee.org/document/10504785)
- [RemoteCLIP modelo en Hugging Face](https://huggingface.co/chendelong/RemoteCLIP)
...
- [Referencias contexto](contexto/referencias.md)
- [Referencias Situación 1](situacion-1/referencias.md)
- [Referencias Situación 2](situacion-2/referencias.md)
- [Referencias Situación 3](situacion-3/referencias.md)

## Documentos internos principales

- [Índice global](README.md)
- [Contexto del proyecto](contexto/README.md)
...
- [Justificaciones](JUSTIFICACIONES.md)
- [Hallazgos EDA](EDA_HALLAZGOS.md)
- [Referencias históricas](REFERENCIAS.md)
